...
@onready var ball_7_cnt = $"Ball Tail Root/Ball Tail 7/Node3D/cnt7"
@onready var ball_6_cnt = $"Ball Tail Root/Ball Tail 6/Node3D/cnt6"
@onready var ball_5_cnt = $"Ball Tail Root/Ball Tail 5/Node3D/cnt5"
@onready var ball_4_cnt = $"Ball Tail Root/Ball Tail 4/Node3D/cnt4"
@onready var ball_3_cnt = $"Ball Tail Root/Ball Tail 3/Node3D/cnt3"
...
func _physics_process(delta):
	...
	ball_8.rotation = lerp(ball_8.rotation, ball_1.rotation + (ball_target.rotation * 3), 0.9)
	...
	#ball_root_node.global_position = lerp(ball_root_node.global_position, $metarig/GeneralSkeleton/BoneAttachment3D.global_position, 0.9)
	ball_1.position = lerp(ball_1.position, ball_target.position, 0.9)
	ball_8.global_position = lerp(ball_8.global_position, ball_1_cnt.global_position + (ball_target.position * 3), 0.9)
